...
<a href="#"><strong><i class="glyphicon glyphicon-dashboard"></i> My Issues</strong></a>  
<hr>

<div class="row">
  <div id="page">
    <?php if(count($projects) > 0):?>
    <ul class="nav nav-tabs nav-pills project-nav">
    ...
    <br>
    <div class="btn-group btn-group-sm tab-content" style="margin-bottom:10px">
